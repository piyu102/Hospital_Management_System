...
const AddMedicineModal = (props) => {
    const { show, setShow, handleClose, setDataChangedFlag ,setAddMedicineModalFlag} = props;
      ...
      <div className="">
        ...
        >
          ...
          <div className="form-group needs-validation">
            ...
            {/* ------------------------medicine charges--------------- */}
            <div className="form-group needs-validation">
              <label className="form-label">Enter medicine Price per tablet</label>
              <input
              onChange={                
                  (e)=>{setMedicinePrice(e.target.value)}
               }
                type="number"
                className="form-control"
              />
